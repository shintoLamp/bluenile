* Encoding: UTF-8.
*********Check total Beddays (HRI Pathways DB3) using Source Individual linkage file*********
***************************************************************************************************************
...
*Exclude East lothian outlier not found in 2015/16 data.
...
*Now classify HRIs.
String HRI_Group1516 (A30).
* Create HRI grouping.
if (lcaP lt 50) HRI_Group1516 = 'High'.
if (lcaP ge 50 and lcaP lt 65) HRI_Group1516 = 'High to Medium'.
if (lcaP ge 65 and lcaP lt 80) HRI_Group1516 = 'Medium'.
if (lcaP ge 80 and lcaP lt 95) HRI_Group1516 = 'Medium to Low'.
if (lcaP ge 95) HRI_Group1516 = 'Low'.
if lca eq '' HRI_Group1516 eq 'Not in LA'.
exe.
...
String FinYear(a10).
compute FinYear='2015/16'.

*Output aggregated total beddays by HRIs for each LCA.
aggregate outfile=*
 /break FinYear lca agegroup genderSTR HRI_Group1516
...
save outfile = !file + 'Beddays_by_LCA_201516.zsav'
   /zcompressed.

*Formatting variables.
get file = !file + 'Beddays_by_LCA_201516.zsav'.
...
save outfile = !file + 'Beddays_by_LCA_201516.zsav'
  /keep FinYear LCAname agegroup genderSTR HRI_Group1516 acute_beddays mat_beddays MH_beddays gls_beddays
  /zcompressed.
