...
* File save location.
define !OFilesL()
       '/conf/sourcedev/TableauUpdates/HRIpathways/Outputs/LV3/Tableau_Final_Data/'
!Enddefine.
...
get file = !OFilesL + 'temp_HRI_LA_1516.zsav'.
...
*select if LCAname ='Aberdeen City'.
*execute.

*frequencies HRI_Group1516 HRI_Group1617 HRI_Group1718.

save translate outfile = !OFilesL + 'Sankey_Link_dataset_FINAL_Tableau_sorted.xlsx' 
