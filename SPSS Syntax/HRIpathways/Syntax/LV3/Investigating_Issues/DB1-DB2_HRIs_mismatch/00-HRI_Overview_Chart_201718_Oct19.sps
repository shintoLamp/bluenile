...
* File save location.
define !OFilesL()
     '/conf/sourcedev/TableauUpdates/HRIpathways/Outputs/LV3/Checks/HRI_Chart_Test/201718/'
!Enddefine.
...
**Remove HRI cost outlier found in 2016/17, 2017/18.
...
AGGREGATE
  /OUTFILE=!OFilesL +'OVERTABLE_ALL_Ages' + !year +'.sav'
...
Save outfile=!OFilesL +'OVERCHART_ALL_Ages' + !year +'.sav'.
...
AGGREGATE
  /OUTFILE=!OFilesL +'OVERTABLE_IND_Ages' + !year +'.sav'
  /BREAK=lca AgeBand HRI_Group
...
Save outfile=!OFilesL+'OVERCHART_IND_Ages' + !year +'.sav'
/drop LCA_Age.
...
get file =!OFilesL+'OVERCHART_ALL_Ages' + !year + '.sav'.

ALTER TYPE ageband (A15).

add files file=*
/file =!OFilesL+'OVERCHART_IND_Ages' + !year + '.sav'.
...
SAVE OUTFILE= !OFilesL+ 'OVERCHART_' + !year + '_Final.sav'
...
get file=!OFilesL+'OVERTABLE_ALL_Ages' + !year + '.sav'.

ALTER TYPE ageband (A15).


add files file =*
/file =!OFilesL+'OVERTABLE_IND_Ages' + !year + '.sav'.
exe.
...
save outfile =!OFilesL+'tempOverTable_' + !year + 'data.sav'
...
get file=!OFilesL+'OVERCHART_' + !year + '_Final.sav'.
...
add files file = *
/file= !OFilesL+'tempOverTable_' + !year + 'data.sav'.
exe.
...
/type=xls /version=12 /fieldnames/replace
  /COMPRESSED.
exe.
*************************************************************************************************************************************************.
