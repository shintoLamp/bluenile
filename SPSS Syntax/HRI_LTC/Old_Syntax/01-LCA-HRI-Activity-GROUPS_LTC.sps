...
Define !HRIfileGroups()
     '/conf/irf/09-Tableau-Outputs/01-Development/02-SPSS-Outputs/03-HRI/LTC/01-HRI-1516_groups.sav'.
!Enddefine.
...
*get file =  '/conf/hscdiip/euanpa01/01-HRI-1415.sav'.
...
mentalh_episodes mentalh_daycase_episodes mentalh_inpatient_episodes mentalh_el_inpatient_episodes mentalh_non_el_inpatient_episodes mentalh_cost
mentalh_daycase_cost mentalh_inpatient_cost mentalh_el_inpatient_cost mentalh_non_el_inpatient_cost mentalh_inpatient_beddays mentalh_el_inpatient_beddays
mentalh_non_el_inpatient_beddays gls_episodes gls_daycase_episodes gls_inpatient_episodes gls_el_inpatient_episodes gls_non_el_inpatient_episodes gls_cost
...
op_newcons_attendances op_newcons_dnas op_cost_attend op_cost_dnas ae_attendances ae_cost pis_dispensed_items pis_cost deceased_flag hbres lca
...
Select if lcaFlag50=1.
Select if mentalh_episodes ge 1.
Execute.
...
/cvdC copdC dementiaC diabetesC chdC hefailureC refailureC epilepsyC asthmaC atrialfibC cancerC arthC parkinsonsC liverC msC No_LTCC Neurodegenerative Cardio Respiratory OtherOrgan Any_LTC
            =sum(cvd copd dementia diabetes chd hefailure refailure epilepsy asthma atrialfib cancer arth parkinsons liver ms No_LTC Neurodegenerative Cardio Respiratory OtherOrgan Any_LTC)
/Total_Cost = sum(mentalh_cost)
/Total_Beddays = sum(mentalh_inpatient_beddays).
Execute.
...
compute Total_Beddays = acute_inpatient_beddays + mentalh_inpatient_beddays + mat_inpatient_beddays + gls_inpatient_beddays.
exe.
