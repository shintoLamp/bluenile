...
Define !file()
     '/conf/sourcedev/TableauUpdates/HRI/Outputs/1920/'
!Enddefine.
...
Define !HRIfile255075()
      !Quote(!Concat("/conf/sourcedev/TableauUpdates/HRI/Outputs/1920/01-HRI-", !UnQuote(!Eval(!year)), "-255075.zsav")).
!Enddefine.
...
Acute - Acute Daycase, Acute Inpatient Elective, Acute Inpatient Non Elective, 
...
*FC Feb. 2019. 
*Non-Service Users must be excluded by the calculations (only for FY 2015/16 onwards).
*For previous FY (e.g. 2014/15, 2013/14,etc). the following line can be greyed out.
*Otherwise, these users will be counted in the 'Low Users' category.
select if NSU ne 1.

*Remove HRI outlier. This was found for FY 2016/17 and 2017/18 only.
*Check for outliers for next updates.
...
simd2020v2_sc_quintile simd2020v2_sc_decile simd2020v2_HB2019_decile simd2020v2_HB2019_quintile cvd copd dementia diabetes chd hefailure refailure epilepsy asthma atrialfib 
...
Save outfile=!file+'/08-Acute-costs-HRI_LCA50.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-Acute-costs-HRI_LCA65.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-Acute-costs-HRI_LCA80.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-Acute-costs-HRI_LCA95.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-Acute-costs-HRI_LCAALL.zsav'
  /zcompressed.


** Bring all Acute file together and create totals.

add files file =!file+'/08-Acute-costs-HRI_LCAALL.zsav'
 /file =!file+'/08-Acute-costs-HRI_LCA50.zsav'
 /file =!file+'/08-Acute-costs-HRI_LCA65.zsav'
 /file =!file+'/08-Acute-costs-HRI_LCA80.zsav'
 /file =!file+'/08-Acute-costs-HRI_LCA95.zsav'.
 

Save outfile=!file+'/08-Acute-costs-HRI_LCA_Temp1.zsav'
  /zcompressed.

compute ageband = 'All ages'.
aggregate outfile=!file+'/08-Acute-costs-HRI_LCA_Temp2.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays)
 /NumberPatients =sum(NumberPatients).


add files file =!file+'/08-Acute-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-Acute-costs-HRI_LCA_Temp2.zsav'.
execute. 

compute gender = 0.
aggregate outfile=!file+'/08-Acute-costs-HRI_LCA_Temp3.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays)
 /NumberPatients =sum(NumberPatients).
...
add files file =!file+'/08-Acute-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-Acute-costs-HRI_LCA_Temp2.zsav'
 /file =!file+'/08-Acute-costs-HRI_LCA_Temp3.zsav'.
execute. 

Save outfile=!file+'/08-Acute-costs-HRI_LCA_Final13.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-MH-costs-HRI_LCA50.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-MH-costs-HRI_LCA65.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-MH-costs-HRI_LCA80.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-MH-costs-HRI_LCA95.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-MH-costs-HRI_LCAALL.zsav'
  /zcompressed.


** Bring all Acute file together and create totals.

add files file =!file+'/08-MH-costs-HRI_LCAALL.zsav'
 /file =!file+'/08-MH-costs-HRI_LCA50.zsav'
 /file =!file+'/08-MH-costs-HRI_LCA65.zsav'
 /file =!file+'/08-MH-costs-HRI_LCA80.zsav'
 /file =!file+'/08-MH-costs-HRI_LCA95.zsav'.
 

Save outfile=!file+'/08-MH-costs-HRI_LCA_Temp1.zsav'
  /zcompressed.

compute ageband = 'All ages'.
aggregate outfile=!file+'/08-MH-costs-HRI_LCA_Temp2.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays)      
 /NumberPatients =sum(NumberPatients).


add files file =!file+'/08-MH-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-MH-costs-HRI_LCA_Temp2.zsav'.
execute. 

compute gender = 0.
aggregate outfile=!file+'/08-MH-costs-HRI_LCA_Temp3.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays)     
 /NumberPatients =sum(NumberPatients).
...
add files file =!file+'/08-MH-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-MH-costs-HRI_LCA_Temp2.zsav'
 /file =!file+'/08-MH-costs-HRI_LCA_Temp3.zsav'.
execute. 

Save outfile=!file+'/08-MH-costs-HRI_LCA_Final13.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-GLS-costs-HRI_LCA50.zsav' 
 /zcompressed.
...
Save outfile=!file+'/08-GLS-costs-HRI_LCA65.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-GLS-costs-HRI_LCA80.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-GLS-costs-HRI_LCA95.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-GLS-costs-HRI_LCAALL.zsav'.


** Bring all Acute file together and create totals.

add files file =!file+'/08-GLS-costs-HRI_LCAALL.zsav'
 /file =!file+'/08-GLS-costs-HRI_LCA50.zsav'
 /file =!file+'/08-GLS-costs-HRI_LCA65.zsav'
 /file =!file+'/08-GLS-costs-HRI_LCA80.zsav'
 /file =!file+'/08-GLS-costs-HRI_LCA95.zsav'.
 

Save outfile=!file+'/08-GLS-costs-HRI_LCA_Temp1.zsav'
  /zcompressed.

compute ageband = 'All ages'.
aggregate outfile=!file+'/08-GLS-costs-HRI_LCA_Temp2.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays)    
 /NumberPatients =sum(NumberPatients).


add files file =!file+'/08-GLS-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-GLS-costs-HRI_LCA_Temp2.zsav'.
execute. 

compute gender = 0.
aggregate outfile=!file+'/08-GLS-costs-HRI_LCA_Temp3.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays)    
 /NumberPatients =sum(NumberPatients).
...
add files file =!file+'/08-GLS-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-GLS-costs-HRI_LCA_Temp2.zsav'
 /file =!file+'/08-GLS-costs-HRI_LCA_Temp3.zsav'.
execute. 

Save outfile=!file+'/08-GLS-costs-HRI_LCA_Final13.zsav'.
...
Save outfile=!file+'/08-MAT-costs-HRI_LCA50.zsav'
 /zcompresssed.
...
Save outfile=!file+'/08-MAT-costs-HRI_LCA65.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-MAT-costs-HRI_LCA80.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-MAT-costs-HRI_LCA95.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-MAT-costs-HRI_LCAALL.zsav'
  /zcompressed.


** Bring all Acute file together and create totals.

add files file =!file+'/08-MAT-costs-HRI_LCAALL.zsav'
 /file =!file+'/08-MAT-costs-HRI_LCA50.zsav'
 /file =!file+'/08-MAT-costs-HRI_LCA65.zsav'
 /file =!file+'/08-MAT-costs-HRI_LCA80.zsav'
 /file =!file+'/08-MAT-costs-HRI_LCA95.zsav'.
 

Save outfile=!file+'/08-MAT-costs-HRI_LCA_Temp1.zsav'.

compute ageband = 'All ages'.
aggregate outfile=!file+'/08-MAT-costs-HRI_LCA_Temp2.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays)   
 /NumberPatients =sum(NumberPatients).


add files file =!file+'/08-MAT-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-MAT-costs-HRI_LCA_Temp2.zsav'.
execute. 

compute gender = 0.
aggregate outfile=!file+'/08-MAT-costs-HRI_LCA_Temp3.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays)   
 /NumberPatients =sum(NumberPatients).
...
add files file =!file+'/08-MAT-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-MAT-costs-HRI_LCA_Temp2.zsav'
 /file =!file+'/08-MAT-costs-HRI_LCA_Temp3.zsav'.
execute. 

Save outfile=!file+'/08-MAT-costs-HRI_LCA_Final13.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-OP-costs-HRI_LCA50.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-OP-costs-HRI_LCA65.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-OP-costs-HRI_LCA80.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-OP-costs-HRI_LCA95.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-OP-costs-HRI_LCAALL.zsav'
  /zcompressed.


** Bring all Acute file together and create totals.

add files file =!file+'/08-OP-costs-HRI_LCAALL.zsav'
 /file =!file+'/08-OP-costs-HRI_LCA50.zsav'
 /file =!file+'/08-OP-costs-HRI_LCA65.zsav'
 /file =!file+'/08-OP-costs-HRI_LCA80.zsav'
 /file =!file+'/08-OP-costs-HRI_LCA95.zsav'.
 

*Add in missing beddays variable.
Compute Beddays = 0.
Save outfile=!file+'/08-OP-costs-HRI_LCA_Temp1.zsav'
  /zcompressed.

compute ageband = 'All ages'.
aggregate outfile=!file+'/08-OP-costs-HRI_LCA_Temp2.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays)  
 /NumberPatients =sum(NumberPatients).


add files file =!file+'/08-OP-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-OP-costs-HRI_LCA_Temp2.zsav'.
execute. 

compute gender = 0.
aggregate outfile=!file+'/08-OP-costs-HRI_LCA_Temp3.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays)  
 /NumberPatients =sum(NumberPatients).
...
add files file =!file+'/08-OP-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-OP-costs-HRI_LCA_Temp2.zsav'
 /file =!file+'/08-OP-costs-HRI_LCA_Temp3.zsav'.
  

Save outfile=!file+'/08-OP-costs-HRI_LCA_Final13.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-AE-costs-HRI_LCA50.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-AE-costs-HRI_LCA65.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-AE-costs-HRI_LCA80.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-AE-costs-HRI_LCA95.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-AE-costs-HRI_LCAALL.zsav'
  /zcompressed.


** Bring all Acute file together and create totals.

add files file =!file+'/08-AE-costs-HRI_LCAALL.zsav'
 /file =!file+'/08-AE-costs-HRI_LCA50.zsav'
 /file =!file+'/08-AE-costs-HRI_LCA65.zsav'
 /file =!file+'/08-AE-costs-HRI_LCA80.zsav'
 /file =!file+'/08-AE-costs-HRI_LCA95.zsav'.
 
*Add in missing beddays variable.
Compute Beddays = 0.
Save outfile=!file+'/08-AE-costs-HRI_LCA_Temp1.zsav'
  /zcompressed.

compute ageband = 'All ages'.
aggregate outfile=!file+'/08-AE-costs-HRI_LCA_Temp2.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays) 
 /NumberPatients =sum(NumberPatients).


add files file =!file+'/08-AE-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-AE-costs-HRI_LCA_Temp2.zsav'.
execute. 

compute gender = 0.
aggregate outfile=!file+'/08-AE-costs-HRI_LCA_Temp3.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays)  
 /NumberPatients =sum(NumberPatients).
...
add files file =!file+'/08-AE-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-AE-costs-HRI_LCA_Temp2.zsav'
 /file =!file+'/08-AE-costs-HRI_LCA_Temp3.zsav'.
execute. 

Save outfile=!file+'/08-AE-costs-HRI_LCA_Final13.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-PIS-costs-HRI_LCA50.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-PIS-costs-HRI_LCA65.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-PIS-costs-HRI_LCA80.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-PIS-costs-HRI_LCA95.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-PIS-costs-HRI_LCAALL.zsav'
  /zcompressed.


** Bring all Acute file together and create totals.

add files file =!file+'/08-PIS-costs-HRI_LCAALL.zsav'
 /file =!file+'/08-PIS-costs-HRI_LCA50.zsav'
 /file =!file+'/08-PIS-costs-HRI_LCA65.zsav'
 /file =!file+'/08-PIS-costs-HRI_LCA80.zsav'
 /file =!file+'/08-PIS-costs-HRI_LCA95.zsav'.
 
*Add in missing beddays variable.
Compute Beddays = 0.
Save outfile=!file+'/08-PIS-costs-HRI_LCA_Temp1.zsav'
  /zcompressed.

compute ageband = 'All ages'.
aggregate outfile=!file+'/08-PIS-costs-HRI_LCA_Temp2.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays)  
 /NumberPatients =sum(NumberPatients).


add files file =!file+'/08-PIS-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-PIS-costs-HRI_LCA_Temp2.zsav'.
execute. 

compute gender = 0.
aggregate outfile=!file+'/08-PIS-costs-HRI_LCA_Temp3.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays)  
 /NumberPatients =sum(NumberPatients).
...
add files file =!file+'/08-PIS-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-PIS-costs-HRI_LCA_Temp2.zsav'
 /file =!file+'/08-PIS-costs-HRI_LCA_Temp3.zsav'.
execute. 

Save outfile=!file+'/08-PIS-costs-HRI_LCA_Final13.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-ALL-costs-HRI_LCA50.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-ALL-costs-HRI_LCA65.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-ALL-costs-HRI_LCA80.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-ALL-costs-HRI_LCA95.zsav'
  /zcompressed.
...
Save outfile=!file+'/08-ALL-costs-HRI_LCAALL.zsav'
  /zcompressed.


** Bring all Acute file together and create totals.

add files file =!file+'/08-ALL-costs-HRI_LCAALL.zsav'
 /file =!file+'/08-ALL-costs-HRI_LCA50.zsav'
 /file =!file+'/08-ALL-costs-HRI_LCA65.zsav'
 /file =!file+'/08-ALL-costs-HRI_LCA80.zsav'
 /file =!file+'/08-ALL-costs-HRI_LCA95.zsav'.
 

Save outfile=!file+'/08-ALL-costs-HRI_LCA_Temp1.zsav'
  /zcompressed.

compute ageband = 'All ages'.
aggregate outfile=!file+'/08-ALL-costs-HRI_LCA_Temp2.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays)  
 /NumberPatients =sum(NumberPatients).


add files file =!file+'/08-ALL-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-ALL-costs-HRI_LCA_Temp2.zsav'.
execute. 

compute gender = 0.
aggregate outfile=!file+'/08-ALL-costs-HRI_LCA_Temp3.zsav'
 /break= lca gender AgeBand UserType ServiceType
 /Total_Cost Episodes_Attendances Beddays=Sum(Total_Cost Episodes_Attendances Beddays)  
 /NumberPatients =sum(NumberPatients).
...
add files file =!file+'/08-ALL-costs-HRI_LCA_Temp1.zsav'
 /file =!file+'/08-ALL-costs-HRI_LCA_Temp2.zsav'
 /file =!file+'/08-ALL-costs-HRI_LCA_Temp3.zsav'.
  

Save outfile=!file+'/08-ALL-costs-HRI_LCA_Final13.zsav'
  /zcompressed.
******************************************************************************************************************************************************************************.
** ADD files together and create required geographies.

add files file =!file+'/08-ALL-costs-HRI_LCA_Final13.zsav'
 /file =!file+'/08-Acute-costs-HRI_LCA_Final13.zsav'
 /file =!file+'/08-MH-costs-HRI_LCA_Final13.zsav'
 /file =!file+'/08-GLS-costs-HRI_LCA_Final13.zsav'
 /file =!file+'/08-MAT-costs-HRI_LCA_Final13.zsav'
 /file =!file+'/08-OP-costs-HRI_LCA_Final13.zsav'
 /file =!file+'/08-AE-costs-HRI_LCA_Final13.zsav'
 /file =!file+'/08-PIS-costs-HRI_LCA_Final13.zsav'.
...
Save outfile=!file+'/TAB-TDE-ALL-costs-HRI_LCA_Final' + !year + '.zsav'
...
get file=!file+'/TAB-TDE-ALL-costs-HRI_LCA_Final' + !year + '.zsav'.
**********************************************************************************************************************************************.
*DELETE working FILES FOR HOUSEKEEPING*.
ERASE FILE= !file+'/08-Acute-costs-HRI_LCAALL.zsav'.
ERASE FILE= !file+'/08-Acute-costs-HRI_LCA50.zsav'.
ERASE FILE= !file+'/08-Acute-costs-HRI_LCA65.zsav'.
ERASE FILE= !file+'/08-Acute-costs-HRI_LCA80.zsav'.
ERASE FILE= !file+'/08-Acute-costs-HRI_LCA95.zsav'.
ERASE FILE =!file+'/08-Acute-costs-HRI_LCA_Temp1.zsav'.
ERASE FILE =!file+'/08-Acute-costs-HRI_LCA_Temp2.zsav'.   
ERASE FILE =!file+'/08-Acute-costs-HRI_LCA_Temp3.zsav'.

ERASE FILE= !file+'/08-MH-costs-HRI_LCAALL.zsav'.
ERASE FILE= !file+'/08-MH-costs-HRI_LCA50.zsav'.
ERASE FILE= !file+'/08-MH-costs-HRI_LCA65.zsav'.
ERASE FILE= !file+'/08-MH-costs-HRI_LCA80.zsav'.
ERASE FILE= !file+'/08-MH-costs-HRI_LCA95.zsav'.
ERASE FILE =!file+'/08-MH-costs-HRI_LCA_Temp1.zsav'.
ERASE FILE =!file+'/08-MH-costs-HRI_LCA_Temp2.zsav'.   
ERASE FILE =!file+'/08-MH-costs-HRI_LCA_Temp3.zsav'.

ERASE FILE= !file+'/08-MAT-costs-HRI_LCAALL.zsav'.
ERASE FILE= !file+'/08-MAT-costs-HRI_LCA50.zsav'.
ERASE FILE= !file+'/08-MAT-costs-HRI_LCA65.zsav'.
ERASE FILE= !file+'/08-MAT-costs-HRI_LCA80.zsav'.
ERASE FILE= !file+'/08-MAT-costs-HRI_LCA95.zsav'.
ERASE FILE =!file+'/08-MAT-costs-HRI_LCA_Temp1.zsav'.
ERASE FILE =!file+'/08-MAT-costs-HRI_LCA_Temp2.zsav'.   
ERASE FILE =!file+'/08-MAT-costs-HRI_LCA_Temp3.zsav'.

ERASE FILE= !file+'/08-OP-costs-HRI_LCAALL.zsav'.
ERASE FILE= !file+'/08-OP-costs-HRI_LCA50.zsav'.
ERASE FILE= !file+'/08-OP-costs-HRI_LCA65.zsav'.
ERASE FILE= !file+'/08-OP-costs-HRI_LCA80.zsav'.
ERASE FILE= !file+'/08-OP-costs-HRI_LCA95.zsav'.
ERASE FILE =!file+'/08-OP-costs-HRI_LCA_Temp1.zsav'.
ERASE FILE =!file+'/08-OP-costs-HRI_LCA_Temp2.zsav'.   
ERASE FILE =!file+'/08-OP-costs-HRI_LCA_Temp3.zsav'.

ERASE FILE= !file+'/08-AE-costs-HRI_LCAALL.zsav'.
ERASE FILE= !file+'/08-AE-costs-HRI_LCA50.zsav'.
ERASE FILE= !file+'/08-AE-costs-HRI_LCA65.zsav'.
ERASE FILE= !file+'/08-AE-costs-HRI_LCA80.zsav'.
ERASE FILE= !file+'/08-AE-costs-HRI_LCA95.zsav'.
ERASE FILE =!file+'/08-AE-costs-HRI_LCA_Temp1.zsav'.
ERASE FILE =!file+'/08-AE-costs-HRI_LCA_Temp2.zsav'.   
ERASE FILE =!file+'/08-AE-costs-HRI_LCA_Temp3.zsav'.

ERASE FILE= !file+'/08-GLS-costs-HRI_LCAALL.zsav'.
ERASE FILE= !file+'/08-GLS-costs-HRI_LCA50.zsav'.
ERASE FILE= !file+'/08-GLS-costs-HRI_LCA65.zsav'.
ERASE FILE= !file+'/08-GLS-costs-HRI_LCA80.zsav'.
ERASE FILE= !file+'/08-GLS-costs-HRI_LCA95.zsav'.
ERASE FILE =!file+'/08-GLS-costs-HRI_LCA_Temp1.zsav'.
ERASE FILE =!file+'/08-GLS-costs-HRI_LCA_Temp2.zsav'.   
ERASE FILE =!file+'/08-GLS-costs-HRI_LCA_Temp3.zsav'.

ERASE FILE= !file+'/08-PIS-costs-HRI_LCAALL.zsav'.
ERASE FILE= !file+'/08-PIS-costs-HRI_LCA50.zsav'.
ERASE FILE= !file+'/08-PIS-costs-HRI_LCA65.zsav'.
ERASE FILE= !file+'/08-PIS-costs-HRI_LCA80.zsav'.
ERASE FILE= !file+'/08-PIS-costs-HRI_LCA95.zsav'.
ERASE FILE =!file+'/08-PIS-costs-HRI_LCA_Temp1.zsav'.
ERASE FILE =!file+'/08-PIS-costs-HRI_LCA_Temp2.zsav'.   
ERASE FILE =!file+'/08-PIS-costs-HRI_LCA_Temp3.zsav'.

ERASE FILE= !file+'/08-ALL-costs-HRI_LCAALL.zsav'.
ERASE FILE= !file+'/08-ALL-costs-HRI_LCA50.zsav'.
ERASE FILE= !file+'/08-ALL-costs-HRI_LCA65.zsav'.
ERASE FILE= !file+'/08-ALL-costs-HRI_LCA80.zsav'.
ERASE FILE= !file+'/08-ALL-costs-HRI_LCA95.zsav'.
ERASE FILE =!file+'/08-ALL-costs-HRI_LCA_Temp1.zsav'.
ERASE FILE =!file+'/08-ALL-costs-HRI_LCA_Temp2.zsav'.   
ERASE FILE =!file+'/08-ALL-costs-HRI_LCA_Temp3.zsav'.

ERASE FILE=!file+'/08-ALL-costs-HRI_LCA_Final13.zsav'.
ERASE FILE=!file+'/08-Acute-costs-HRI_LCA_Final13.zsav'.
ERASE FILE=!file+'/08-MH-costs-HRI_LCA_Final13.zsav'.
ERASE FILE=!file+'/08-GLS-costs-HRI_LCA_Final13.zsav'.
ERASE FILE=!file+'/08-MAT-costs-HRI_LCA_Final13.zsav'.
ERASE FILE=!file+'/08-OP-costs-HRI_LCA_Final13.zsav'.
ERASE FILE=!file+'/08-AE-costs-HRI_LCA_Final13.zsav'.
ERASE FILE=!file+'/08-PIS-costs-HRI_LCA_Final13.zsav'.
