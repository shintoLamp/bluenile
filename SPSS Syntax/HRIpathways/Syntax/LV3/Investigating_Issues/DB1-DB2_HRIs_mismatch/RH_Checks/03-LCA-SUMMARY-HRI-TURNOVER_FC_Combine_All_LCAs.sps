...
* File save location.
define !OFilesL()
           '/conf/sourcedev/TableauUpdates/HRIpathways/Outputs/LV3/Checks/Tableau_Data/RH/'
!Enddefine.
 ...
 * add files file = *
/file =!OFilesL + 'Sankey_Link_dataset_LCAFINALT_LCA14.sav'
/file =!OFilesL + 'Sankey_Link_dataset_LCAFINALT_LCA17.sav'.
 * execute.
...
save outfile = !OFilesL + '/Summary_Link_dataset_LCAFINAL_Tableau_sorted.sav'
...
get file =  !OFilesL + '/Summary_Link_dataset_LCAFINAL_Tableau_sorted.sav'.
