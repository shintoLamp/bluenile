...
Save outfile=!file+'/10-All-costs-HRI_DZ50.sav'.
...
Save outfile=!file+'/10-All-costs-HRI_DZ65.sav'.
...
Save outfile=!file+'/10-All-costs-HRI_DZ80.sav'.
...
Save outfile=!file+'/10-All-costs-HRI_DZ95.sav'.
...
Save outfile=!file+'/10-All-costs-HRI_DZALL.sav'.


** Bring all Acute file together and create totals.

add files file =!file+'/10-All-costs-HRI_DZALL.sav'
 /file =!file+'/10-All-costs-HRI_DZ50.sav'
 /file =!file+'/10-All-costs-HRI_DZ65.sav'
 /file =!file+'/10-All-costs-HRI_DZ80.sav'
 /file =!file+'/10-All-costs-HRI_DZ95.sav'.
exe.

Save outfile=!file+'/10-All-costs-HRI_DZ_Temp1.sav'.

compute ageband = 'All ages'.
aggregate outfile=!file+'/10-All-costs-HRI_DZ_Temp2.sav'
 /break= datazone lca AgeBand UserType ServiceType
...
add files file =!file+'/10-All-costs-HRI_DZ_Temp1.sav'
 /file =!file+'/10-All-costs-HRI_DZ_Temp2.sav'.
exe. 

Save outfile=!file+'/10-All-costs-HRI_DZ_Final.sav'.

********************************

Get file=!file+'/10-All-costs-HRI_DZ_Final.sav'.
...
Save outfile=!file+'/TAB-TDE-ALL-costs-HRI_DZ_Final' + !year + '.sav'
/keep Year datazone LCAname LA_CODE HB_CODE HBName AgeBand UserType ServiceType Total_Cost Episodes_Attendances Beddays NumberPatients.
...
ERASE FILE= !file+'/10-All-costs-HRI_DZALL.sav'.
ERASE FILE= !file+'/10-All-costs-HRI_DZ50.sav'.
ERASE FILE= !file+'/10-All-costs-HRI_DZ65.sav'.
ERASE FILE= !file+'/10-All-costs-HRI_DZ80.sav'.
ERASE FILE= !file+'/10-All-costs-HRI_DZ95.sav'.
ERASE FILE= !file+'/10-All-costs-HRI_DZ_Temp1.sav'.
ERASE FILE= !file+'/10-All-costs-HRI_DZ_Temp2.sav'.   
ERASE FILE= !file+'/10-ALL-costs-HRI_DZ_Final.sav'.
