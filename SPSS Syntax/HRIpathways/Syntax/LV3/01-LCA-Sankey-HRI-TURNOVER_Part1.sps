...
******************************************************************
*************************************************************************************************************************************************.
*** Start with last financial year (2019/2020).
...
/keep year CHI gender health_net_cost1920 LCA1920  AgeBand LCA1920 HRI_Group1920 health_net_cost1920_min health_net_cost1920_max deceased date_death
/zcompressed.


*All ages.
get file  = !OFilesL + 'temp_HRI_LA_1920_T1.zsav'
/keep year CHI gender health_net_cost1920 LCA1920  AgeBand LCA1920 HRI_Group1920 deceased date_death.
...
* Tidy up.
*ERASE file  = !OFilesL + 'temp_HRI_LA_1920_T1.zsav'.
*ERASE file  = !OFilesL + 'temp_HRI_LA_1920_T2.zsav'.
*ERASE file  = !OFilesL + 'temp_HRI_LA_1920_T3.zsav'.
*ERASE file  = !OFilesL + 'temp_HRI_LA_1920_T4.zsav'.
...
****Rename deceased_flag to deceased for 1415, 1617 data and update lca codes for 'Fife' and 'Perth & Kinross' ****.
match files file = *
...
* Tidy up.
*ERASE file  =  !OFilesL + 'temp_HRI_LA_1819.zsav'.
