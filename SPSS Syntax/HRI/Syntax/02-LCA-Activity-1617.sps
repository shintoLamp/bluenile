...
Define !file()
      !QUOTE(!CONCAT('/conf/sourcedev/TableauUpdates/HRI/Outputs/', !UNQUOTE(!SUBSTR(!EVAL(!year), 4, 4)), '/'))
!Enddefine.

Define !HRIfile255075()
      !Quote(!Concat('/conf/sourcedev/TableauUpdates/HRI/Outputs/', !UNQUOTE(!SUBSTR(!EVAL(!year), 4, 4)), '/', "01-HRI-", !UnQuote(!Eval(!year)), "-255075.zsav")).
!Enddefine.
