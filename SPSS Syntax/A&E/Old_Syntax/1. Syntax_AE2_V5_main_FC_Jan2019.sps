...
compute date_check_1 = char.substr(chi,1,6).
...
RENAME VARIABLES simd2016_HB2014_quintile = simd.
execute. 
...
*Save file with various 'all' values and then aggregate. 
...
*Aggregate up for CHI level (Patient Level)
...
match files file=* 
 /table = '/conf/irf/09-Tableau-Outputs/01-Development/04-Source-Data/99 - Lookups/agegroups' + !year +'.sav' 
 /by lca sex agegroup.
execute. 
