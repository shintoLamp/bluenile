...
*Anonymized CHI used for all the following calculations.
...
*FC Feb 2019. These checks on DoB are not needed anymore as a result of the last Source Linkage file updates.
*Check date of birth.
*alter type dob (a8).
...
if hbrescode eq 'S08000004' hbrescode eq 'S08000029'.
