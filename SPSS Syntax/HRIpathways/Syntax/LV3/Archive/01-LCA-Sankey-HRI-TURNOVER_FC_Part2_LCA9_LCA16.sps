...
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR_CHI9.zsav'
...
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR9.zsav'
  /zcompressed.
...
* Need to save out Pathway lookup to match on the original CHIMASTER level data.
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR_CHI10.zsav'
  /keep chi lca_select PathwayLKP PathwayLabel HRI_Group1718 HRI_Group1617 HRI_Group1415 HRI_Group1516 Remove
  /zcompressed.
...
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR10.zsav'
  /zcompressed.
...
* Need to save out Pathway lookup to match on the original CHIMASTER level data.
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR_CHI11.zsav'
  /keep chi lca_select PathwayLKP PathwayLabel HRI_Group1718 HRI_Group1617 HRI_Group1415 HRI_Group1516 Remove
  /zcompressed.
...
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR11.zsav'
  /zcompressed.
...
* Need to save out Pathway lookup to match on the original CHIMASTER level data.
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR_CHI12.zsav'
  /keep chi lca_select PathwayLKP PathwayLabel HRI_Group1718 HRI_Group1617 HRI_Group1415 HRI_Group1516 Remove
  /zcompressed.
...
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR12.zsav'
  /zcompressed.
...
* Need to save out Pathway lookup to match on the original CHIMASTER level data.
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR_CHI13.zsav'
  /keep chi lca_select PathwayLKP PathwayLabel HRI_Group1718 HRI_Group1617 HRI_Group1415 HRI_Group1516 Remove
  /zcompressed.
...
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR13.zsav'
  /zcompressed.
...
* Need to save out Pathway lookup to match on the original CHIMASTER level data.
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR_CHI14.zsav'
  /keep chi lca_select PathwayLKP PathwayLabel HRI_Group1718 HRI_Group1617 HRI_Group1415 HRI_Group1516 Remove
  /zcompressed.
...
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR14.zsav'
  /zcompressed.
...
* Need to save out Pathway lookup to match on the original CHIMASTER level data.
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR_CHI15.zsav'
  /keep chi lca_select PathwayLKP PathwayLabel HRI_Group1718 HRI_Group1617 HRI_Group1415 HRI_Group1516 Remove
  /zcompressed.
...
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR15.zsav'
  /zcompressed.
...
* Need to save out Pathway lookup to match on the original CHIMASTER level data.
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR_CHI16.zsav'
  /keep chi lca_select PathwayLKP PathwayLabel HRI_Group1718 HRI_Group1617 HRI_Group1415 HRI_Group1516 Remove
  /zcompressed.
...
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR16.zsav'
  /zcompressed.
