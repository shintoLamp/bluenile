...
* File save location.
define !OFilesL ()
       '/conf/sourcedev/TableauUpdates/HRIpathways/Outputs/LV3/Checks/Missing_Data/lca02/'
!Enddefine.
...
get file  = !OFilesL  + 'temp_HRI_LA_MASTER_ALLYR_LCA02.zsav'.
...
save outfile  = !data  + 'temp_HRI_LA_ALLYR_CHI02.zsav'
...
save outfile  = !data  + 'temp_HRI_LA_ALLYR02.zsav'
  /zcompressed.

get file =  !data  + 'temp_HRI_LA_ALLYR02.zsav'.
