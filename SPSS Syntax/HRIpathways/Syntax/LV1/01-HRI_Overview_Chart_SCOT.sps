...
* File save location.
define !OFilesL()
     '/conf/sourcedev/TableauUpdates/HRIpathways/Outputs/LV1/DB1_Chart/'
!Enddefine.

******************************************************************
*add notes.
*************************************************************************************************************************************************.
*** Start with latest year - 2019/2020.
...
AGGREGATE
  /OUTFILE=!OFilesL +'OVERTABLE_ALL_Ages' + !year +'_SCOT.zsav'
...
Save outfile=!OFilesL +'OVERCHART_ALL_Ages' + !year +'_SCOT.zsav'
  /zcompressed.


*** Now - 2019/20 - Individual Age groups.
...
AGGREGATE
  /OUTFILE=!OFilesL +'OVERTABLE_IND_Ages' + !year +'_SCOT.zsav'
  /BREAK=lca AgeBand HRI_Group
...
Save outfile=!OFilesL+'OVERCHART_IND_Ages' + !year +'_SCOT.zsav'  
  /drop LCA_Age
  /zcompressed.


add files file =!OFilesL+'OVERCHART_ALL_Ages' + !year + '_SCOT.zsav'
  /file =!OFilesL+'OVERCHART_IND_Ages' + !year + '_SCOT.zsav'.
exe.
...
SAVE OUTFILE=!OFilesL+'OVERCHART_' + !year + 'SCOT_Final.zsav'
...
*** Now - 17/18 - Individual Age groups.
...
*Main Data.
add files file = !OFilesL +'OVERTABLE_ALL_Ages' + !year +'_SCOT.zsav'
/file =  !OFilesL +'OVERTABLE_IND_Ages' + !year +'_SCOT.zsav'.
exe.
...
Save outfile= !OFilesL +'OVERTable_' + !year +'SCOT_Final.zsav'
  /zcompressed.
...
add files file =  !OFilesL +'OVERTable_201920SCOT_Final.zsav'
/file =   !OFilesL +'OVERTable_201819SCOT_Final.zsav'
/file =  !OFilesL +'OVERTable_201718SCOT_Final.zsav'
/file =   !OFilesL +'OVERTable_201617SCOT_Final.zsav'.
exe.
...
SAVE OUTFILE= !OFilesL +'tempOverTable_SCOTdata.zsav'
  /DROP=lca health_net_cost_min health_net_cost_max health_net_cost_sum
  /zcompressed.



add files file = !OFilesL +'OVERCHART_201920SCOT_Final.zsav'
/file = !OFilesL +'OVERCHART_201819SCOT_Final.zsav'
/file =  !OFilesL +'OVERCHART_201718SCOT_Final.zsav'
/file =  !OFilesL +'OVERCHART_201617SCOT_Final.zsav'.
exe.
...
add files file = *
/file=!OFilesL +'tempOverTable_SCOTdata.zsav'.
exe.
