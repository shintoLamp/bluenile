...
* File save location.
define !OFilesL()
       '/conf/sourcedev/TableauUpdates/HRIpathways/Outputs/LV3/Checks/EdinburghCity/'
!Enddefine.
...
get file  = !OFilesL + 'temp_HRI_LA_MASTER_ALLYR14.zsav'.
...
sort cases by year(a) chi(a).

select if check_max=4.
exe.

save outfile = !OFilesL + 'temp_HRI_LA_ALLYR_CHI1_Sorted.zsav'
  /zcompressed.
