...
save outfile  = !OFilesL + 'Sankey_IndLKP1_all_recs.sav'
/drop Recs.
...
match files file = *
/table = !OFilesL + 'Sankey_IndLKP1_all_recs.sav'
/by CHI.
exe.
...
SAVE OUTFILE=!OFilesL + 'Sankey_Link_dataset_Temp1_all_recs.zsav'
