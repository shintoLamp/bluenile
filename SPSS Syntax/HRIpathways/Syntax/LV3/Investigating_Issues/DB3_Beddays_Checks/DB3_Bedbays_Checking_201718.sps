...
*Now classify HRIs.
String HRI_Group1718 (A30).
* Create HRI grouping.
if (lcaP lt 50) HRI_Group1718 = 'High'.
if (lcaP ge 50 and lcaP lt 65) HRI_Group1718 = 'High to Medium'.
if (lcaP ge 65 and lcaP lt 80) HRI_Group1718 = 'Medium'.
if (lcaP ge 80 and lcaP lt 95) HRI_Group1718 = 'Medium to Low'.
if (lcaP ge 95) HRI_Group1718 = 'Low'.
if lca eq '' HRI_Group1718 eq 'Not in LA'.
exe.
...
String FinYear(a10).
compute FinYear='2017/18'.

*Output aggregated total beddays by HRIs for each LCA.
aggregate outfile=*
 /break FinYear lca agegroup genderSTR HRI_Group1718
...
save outfile = !file + 'Beddays_by_LCA_201718.zsav'
   /zcompressed.
...
save outfile = !file + 'Beddays_by_LCA_201718.zsav'
  /keep FinYear LCAname agegroup genderSTR HRI_Group1718 acute_beddays mat_beddays MH_beddays gls_beddays
  /zcompressed.
