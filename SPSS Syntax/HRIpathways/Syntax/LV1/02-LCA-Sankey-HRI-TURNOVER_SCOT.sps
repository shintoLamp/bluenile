...
*define !CostedFiles()
'/conf/irf/10-PLICS-analysis-files/masterPLICS_Costed_201819.sav'
!enddefine.

*define !CHICostedFiles()
'/conf/irf/10-PLICS-analysis-files/CHImasterPLICS_Costed_201819.sav'
!enddefine.
...
*Define !HRIfile255075()
     '/conf/linkage/output/keirro/01-HRI-1819-255075.sav'
!Enddefine.
******************************************************************
*add notes.
*************************************************************************************************************************************************.
...
*Check and eventually remove HRI cost outlier found for 2017/18 and 2016/17 activities.
...
rename variables (lca HRI_Group health_net_cost = lca1920 HRI_Group1920 health_net_cost1920).
...
AGGREGATE
  ...
  /BREAK=AgeBand gender HRI_Group1920 lca1920
  /health_net_cost1920_min=MIN(health_net_cost1920) 
  /health_net_cost1920_max=MAX(health_net_cost1920).

save outfile  = !OFilesL + 'temp_HRI_LA_1920_T1.zsav'
  /keep year CHI gender health_net_cost1920 lca1920 DataZone2011 AgeBand LCA1920 HRI_Group1920 health_net_cost1920_min health_net_cost1920_max deceased death_date
  /zcompressed.

*All ages.
get file  = !OFilesL + 'temp_HRI_LA_1920_T1.zsav'
/keep year CHI gender health_net_cost1920 lca1920 DataZone2011 AgeBand LCA1920 HRI_Group1920 deceased death_date.
...
save outfile  = !OFilesL + 'temp_HRI_LA_1920_T2.zsav'
  /keep year CHI gender health_net_cost1920 lca1920 DataZone2011 AgeBand LCA1920 HRI_Group1920 health_net_cost1920_min health_net_cost1920_max deceased death_date
  /zcompressed. 
...
save outfile  = !OFilesL + 'temp_HRI_LA_1920_T3.zsav'
   /keep year CHI gender health_net_cost1920 lca1920 DataZone2011 AgeBand LCA1920 HRI_Group1920 health_net_cost1920_min health_net_cost1920_max deceased death_date
   /zcompressed.
...
save outfile  = !OFilesL + 'temp_HRI_LA_1920_T4.zsav'
  /keep year CHI gender health_net_cost1920 lca1920 DataZone2011 AgeBand LCA1920 HRI_Group1920 health_net_cost1920_min health_net_cost1920_max deceased death_date
  /zcompressed.

add files file = !OFilesL + 'temp_HRI_LA_1920_T1.zsav'
/file = !OFilesL + 'temp_HRI_LA_1920_T2.zsav'
/file = !OFilesL + 'temp_HRI_LA_1920_T3.zsav'
/file = !OFilesL + 'temp_HRI_LA_1920_T4.zsav'.
execute.
...
save outfile  = !OFilesL + 'temp_HRI_LA_1920.zsav'
  /zcompressed.

get file = !OFilesL + 'temp_HRI_LA_1920.zsav'.

* Tidy up.
*ERASE file  = !OFilesL + 'temp_HRI_LA_1920_T1.sav'.
*ERASE file  = !OFilesL + 'temp_HRI_LA_1920_T2.sav'.
*ERASE file  = !OFilesL + 'temp_HRI_LA_1920_T3.sav'.
*ERASE file  = !OFilesL + 'temp_HRI_LA_1920_T4.sav'.
...
*Check and remove HRI cost outlier found for 2017/18 and 2016/17 activities.
Select if Anon_CHI ne 'MDMwNTM2MTEzOQ=='.
exe.
...
save outfile  = !OFilesL + 'temp_HRI_LA_1819_T1.zsav'
  /keep year CHI gender health_net_cost1819 lca1819 DataZone2011 AgeBand LCA1819 HRI_Group1819 health_net_cost1819_min health_net_cost1819_max deceased death_date
  /zcompressed.

*All ages.
get file  = !OFilesL + 'temp_HRI_LA_1819_T1.zsav'
  /keep year CHI gender health_net_cost1819 lca1819 DataZone2011 AgeBand LCA1819 HRI_Group1819 deceased death_date.
...
* Tidy up.
*ERASE file  = !OFilesL + 'temp_HRI_LA_1819_T1.sav'.
*ERASE file  = !OFilesL + 'temp_HRI_LA_1819_T2.sav'.
*ERASE file  = !OFilesL + 'temp_HRI_LA_1819_T3.sav'.
*ERASE file  = !OFilesL + 'temp_HRI_LA_1819_T4.sav'.
...
match files file = *
/file =  !OFilesL + 'temp_HRI_LA_1819.zsav'
...
* Tidy up.
*ERASE file  =  !OFilesL + 'temp_HRI_LA_1920.sav'.
*ERASE file  =  !OFilesL + 'temp_HRI_LA_1617.sav'.
*ERASE file  =  !OFilesL + 'temp_HRI_LA_1718.sav'.
*ERASE file  =  !OFilesL + 'temp_HRI_LA_1819.sav'.
...
compute PathwayLabel = concat(HRI_Group1617, ' - ', HRI_Group1718, ' - ', HRI_Group1819, ' - ', HRI_Group1920).
exe. 
...
save outfile  = !OFilesL + 'temp_HRI_LA_ALLYR_CHI1.zsav'
  /keep chi PathwayLKP PathwayLabel HRI_Group1617 HRI_Group1718 HRI_Group1819 HRI_Group1920 remove
  /zcompressed.
...
AGGREGATE
  /OUTFILE=*
  /BREAK=genderSTR AgeBand HRI_Group1920 HRI_Group1617 HRI_Group1718 HRI_Group1819 PathwayLKP PathwayLabel
...
save outfile = !OFilesL+ 'Sankey_Link_dataset_FINAL_SCOT_Tableau_sorted.sav'
  /keep Link Data LCAname LA_CODE GenderSTR AgeBand HRI_Group1617 HRI_Group1718 HRI_Group1819 HRI_Group1920 
           PathwayLKP health_net_cost1920 health_net_cost1617 health_net_cost1718 health_net_cost1819 
           health_net_cost1920_min health_net_cost1920_max health_net_cost1617_min  health_net_cost1617_max health_net_cost1718_min
           health_net_cost1718_max health_net_cost1819_min  health_net_cost1819_max  health_net_cost Size Year TNum_LTC TNum_LTC_GRP
...
get file = !OFilesL+ 'Sankey_Link_dataset_FINAL_SCOT_Tableau_sorted.sav'.

save translate outfile = !OFilesL + 'Sankey_Link_dataset_FINAL_SCOT_Tableau_sorted.csv' 
