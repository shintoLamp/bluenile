...
* File save location.
define !OFilesL ()
       '/conf/sourcedev/TableauUpdates/HRIpathways/Outputs/LV3/Sankey_DB2/Highland/'
!Enddefine.
...
get file  = !OFilesL  + 'temp_HRI_LA_MASTER_ALLYR_Highland.zsav'.
...
get file =  !data  + 'temp_HRI_LA_ALLYR18.zsav'.
