* Encoding: UTF-8.
* A&E Syntax to create population figures for different demographic breakdowns using raw population estimates.
* Updated - Rachael Bainbridge 17/01/2019.
* Updated - Bateman McBride April 2020.
* Last Updated - Federico Centoni Dec 2020

* Macros to define year.
* NOTE: 201920 financial year uses 2019 population estimates so syntax reflects this, as so for every year 
* Last Population estimates file (CA2019_pop_est_1981_2019.sav) released on May 2020.
* Need to run from 19/20 to update year.
...
* Run on sourcedev.
Define !file()
'/conf/sourcedev/TableauUpdates/A&E/Outputs/Population_Data/'
!Enddefine. 
...
If (lca=3) or (lca=9) or (lca=25) hbres = 'S08000030'.
